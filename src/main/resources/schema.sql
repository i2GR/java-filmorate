...
CREATE TABLE IF NOT EXISTS friends (
  ...
  CONSTRAINT frd_unq UNIQUE (owner_id, friend_id),
  CONSTRAINT frd_chk CHECK (owner_id <> friend_id)
);
...
CREATE TABLE IF NOT EXISTS film_genres (
  ...
  CONSTRAINT fg_unq UNIQUE (film_id, genre_id)
);
...
CREATE TABLE IF NOT EXISTS user_liked_film (
  ...
  CONSTRAINT fll_unq UNIQUE (user_id, film_id)
);