...
public class FriendPair extends ActivityEvent {
    ...
    @NotNull(message = "initiator id is null")
   ...
   public FriendPair(Long idOne, Long idTwo) {
        this(idOne, idTwo, idOne, false);
    }

    public FriendPair(Long idOne, Long idTwo, Long init) {
        this(idOne, idTwo, init, false);
    }

    public FriendPair(Long idOne, Long idTwo, Long init, boolean conf) {
