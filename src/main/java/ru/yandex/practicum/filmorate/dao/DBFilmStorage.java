...
public class DBFilmStorage implements FilmStorage {
    ...
    private List<Film> readAllFilmsFromDB(String sqlQuery) {
        ...
        Map<Long, List<String>> filmIdToGenresList = getFilmGenresCommon();
        for(Film film: films) {
    ...
    private List<String> getGenresById(Long filmId) {
    ...
    private Map<Long, List<String>> getFilmGenresCommon() {
        String sqlQuery = "SELECT fg.film_id AS film_id, g.name AS name "
                            + "FROM film_genres AS fg "
